  ...
  <div class="container">
    ...
    <?php
      ...
      <form method="post" action="">
          <button name="submit2" type="submit" class="btn btn-default">RETURNED</button> 
                      &nbsp&nbsp
    ...
    $c=0;
        ...
        $sql="SELECT student.username,books.bid,name,authors,edition,approve,issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve ='$ret' ORDER BY `issue_book`.`return` DESC";
        ...
        {
        $sql="SELECT student.username,books.bid,name,authors,edition,approve,issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve !='' and issue_book.approve !='Yes' ORDER BY `issue_book`.`return` DESC";
        $res=mysqli_query($db,$sql);
        }
        ...
        echo "<tr style='background-color: maroon;'>";
