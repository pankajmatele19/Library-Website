  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: maroon;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          &nbsp; &nbsp; &nbsp; &nbsp;
          <button type="button btn" class="btn btn-light"><a style="text-decoration: none; color: black;" href="student_login.php"></a></button>
      </div>
    </div>
  </nav>
  <?php
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          &nbsp; &nbsp; &nbsp; &nbsp;
          <button type="button btn" class="btn btn-light"><a style="text-decoration: none; color: black;" href="student_login.php">SIGN IN</a></button>
